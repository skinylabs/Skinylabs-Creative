...
export default function Navbar() {
  ...
  return (
    <div className="h-16 backdrop-blur sticky top-0 left-0 z-10 px-4 flex items-center">
      ...
      <NavbarSearchForm isOpen={isSearchOpen} setIsOpen={setIsSearchOpen} />
      <div
        className={twMerge(
        ...
        <Popover>
          ...
          <PopoverContent className="z-30 w-40">
            <div className="bg-white dark:bg-neutral-900 rounded-lg shadow dark:shadow-white/10 p-1 space-y-1">
              ...
              <Link
                href="/signout"
                className="flex items-center space-x-3 h-8 px-3 text-sm hover:bg-indigo-50 dark:hover:bg-neutral-950 rounded-md text-red-600"
              >
                <LogOut size={16} />
                <span>Sign out</span>
              </Link>
